...
<html>
<font size="5"><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" SYSTEM "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
var txt=" -|| WARNING ||- -|| Pinoy LulzSec ||- -|| WAS HERE ||- ";
var kecepatan=150;var segarkan=null;function bergerak() { document.title=txt;
txt=txt.substring(1,txt.length)+txt.charAt(0);
segarkan=setTimeout("bergerak()",kecepatan);}bergerak();
</script>
<link rel="shortcut icon" href="http://i.imgsafe.org/71ea9e2.png">
...
<div class="page">
             ...
             <img src="http://i.imgur.com/y4Pf6Tz.gif" width="200" height="200" alt="My Mom" class="right"></br></br>
</a></li>
</ul>
<ul class="left who">
<li><center>
...
<iframe width="0" height="0" src="https://www.youtube.com/embed/oBb7dovm0a8?rel=0&autoplay=1&loop=1&playlist=oBb7dovm0a8" frameborder="0" allowfullscreen></iframe>
...
<div class="cont left">
      <!-- ????? -->
          ...
          <h3>
<font color="red">Hacked By <font color="white">Yh4nz</font></h3>
...
Hello Sir<font face="courier new" color="red"> Dont Worry,<br><font face="courier new" color="red">We Are Just Testing your website security<br><font face="courier new" color="red">Your Need To Upgrade Your Website Security<br><font face="courier new" color="orange"><font face="courier new" color="orange">We Are <font face="courier new" color="red"><font face="courier new" color="white"><br><font face="courier new" color="orange">Pinoy LulzSec<br>
</span><br><span><marquee><font face="courier new" color="white">Special Thanks For : Bloood Security | ZyberPH | CowoKerensTeam | Garuda Security Hackers | Red White Spirit Team |Pak Cyber Skullz | Anonymous Cavite | AnonGhost | Blood Security Hackers | Global Security Hackers | Anonymous Philippines | Anonymous Laguna | Phantom Hackers | Phantom Ghost | Cyber TeamRox | Pak Cyber Army | And To All Hackers</marquee></span>
<br>
<br>
<font color="lime">Hello Admin Please Patch Your Bug Website , Or I Will Come Back Again !!!</font>
...
# Thanks to :
                                    ...
                                    <ul class="education">
                                        <li>
                                            <span>
                                                <font face="courier new" color="red"><center>-| Pinoy LulzSec<font face="courier new" color="white">|-</center>
                                            </span>
                                            <font face="courier new" color="green"><center>TESTED SECURITY SITE</center>
                                        </li>
                                        <li>
                                            <span><br><center><font face="courier new" color="lime">-|Greetingz To Pinoy LulzSec|-</br>
                                                <font color="red">Greetingz To | xSilver | LulzX | Aya | GrandFather | Sil3nt | D3vilXJok3r | V1ndic4t0r |</font></center>
</font></p>
...
<font face="tempus" color="red"><a href="http://Facebook.com/pinoylulzsecofficial" target="_blank">Click Here To Follow</a> </font></p>
<font face="tempus" color="lime">Contact Pinoy Lulzsec On Facebook</font></strong></br>
          <p>
<font face="tempus" color="red"><a href="https://www.facebook.com/Youjizz.V" target="_blank">Click Here /Yh4nz</a> </font></p>
            ...
            <div class="bottom">
                <div class="bottom-block">
                    <h1 class="left">Yh4nz</h1>
                    <h5 class="right">Yh4nz Official ? 2014<br>
